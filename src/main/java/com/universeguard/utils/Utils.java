...
public class Utils {
	...
	public static ItemStack getSelector() {
		ItemStack selector = ItemStack.builder().itemType(ItemTypes.WOODEN_AXE).build();
		selector.offer(Keys.DISPLAY_NAME, Text.of(TextColors.LIGHT_PURPLE, "Приват-топорик"));
	...
	public static String getPermission(String p) {
        ...
        public static int getMaxPrivateCount(String p){
            return getConfig().getConfig().getNode(p).getInt();
        }
